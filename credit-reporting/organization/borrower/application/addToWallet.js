...
const wallet = new FileSystemWallet('../identity/user/wendy/wallet');
...
async function main() {
    ...
    try {
        ...
        const cert = fs.readFileSync(path.join(credPath, '/msp/signcerts/User1@org1.example.com.pem')).toString();
